...
public class Emojis {
    ...
    public static void main(String[] args) {
        ...
        GraphicsGroup littleWink = createWinkingFace(100);
        littleWink.setPosition(50,200);
        canvas.add(littleWink);
    }
    ...
    public static GraphicsGroup createWinkingFace(double size){
        ...
        Ellipse eyeOne = createEye(size*.2, size*.2);
        eyeOne.setCenter(size*.3, size * .3);
        group.add(eyeOne);

        Rectangle eyeTwo = createWink(size *.2, size *.08);
        eyeTwo.setCenter(size * .65, size *.3);
        group.add(eyeTwo);
    ...
    public static GraphicsGroup createSmileyFace(double size) {
        ...
        Ellipse eyeTwo = createEye(size*.2, size*.2);
        eyeTwo.setCenter(size*.65, size * .3);
        group.add(eyeTwo);
    ...
    private static Ellipse createEye(double ellipseWidth, double ellipseHeight){
        ...
        eye.setFillColor(new Color(0,0,0));
        return eye;
    }
    public static Rectangle createWink(double rectangleWidth, double rectangleHeight){
        Rectangle wink = new Rectangle(0,0,rectangleWidth, rectangleHeight);
        wink.setFillColor(new Color(0,0,0));
        return wink;
    }
}
